...
RSpec.describe Api::V1::MoviesController, type: :routing do
  describe "routing" do
    ...
    it "routes to #create" do
      expect(post: "/api/v1/movies").not_to be_routable
    end

    it "routes to #update via PUT" do
      expect(put: "/api/v1/movies/1").not_to be_routable
    end

    it "routes to #update via PATCH" do
      expect(patch: "/api/v1/movies/1").not_to be_routable
    end

    it "routes to #destroy" do
      expect(delete: "/api/v1/movies/1").not_to be_routable
    end
  end
end
